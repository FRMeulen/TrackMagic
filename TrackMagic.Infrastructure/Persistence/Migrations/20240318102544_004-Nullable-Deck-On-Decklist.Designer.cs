...
namespace TrackMagic.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240318102544_004-Nullable-Deck-On-Decklist")]
    partial class _004NullableDeckOnDecklist
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DecklistCardsJoinTable", b =>
                {
                    ...
                    b.HasKey("CardsId", "UsedInId");

                    b.HasIndex("UsedInId");

                    b.ToTable("DecklistCardsJoinTable");
                });
            ...
            modelBuilder.Entity("DecklistCardsJoinTable", b =>
                {
                    ...
                    b.HasOne("TrackMagic.Domain.Entities.Decklist", null)
                        .WithMany()
