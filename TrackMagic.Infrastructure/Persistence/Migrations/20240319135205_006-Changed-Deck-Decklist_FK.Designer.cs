...
namespace TrackMagic.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240319135205_006-Changed-Deck-Decklist_FK")]
    partial class _006ChangedDeckDecklist_FK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrackMagic.Domain.Entities.Deck", b =>
                {
                    ...
                    b.HasIndex("DecklistId")
                        .IsUnique()
                        .HasFilter("[DecklistId] IS NOT NULL");
            ...
            modelBuilder.Entity("TrackMagic.Domain.Entities.Deck", b =>
                {
                    ...
                    b.HasOne("TrackMagic.Domain.Entities.Decklist", "Decklist")
                        .WithOne("Deck")
                        .HasForeignKey("TrackMagic.Domain.Entities.Deck", "DecklistId")
